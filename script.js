...
function addNote(){
    ...
    if(inputTitle.value === "" || inputDesc.value === ""){
     ...
     <p class="open"><i class="fas fa-envelope-open"></i></p>
       <div class="content">
...
function modifyNote(filter){
    ...
    if(filter.classList.contains("fa-envelope-open")){
      
        textField.classList.remove("d-none");
        addNoteBtn.classList.add("d-none");
        saveNoteBtn.classList.add("d-none");
        inputTitle.style.backgroundColor= filter.parentElement.parentElement.style.backgroundColor;
        inputDesc.style.backgroundColor= filter.parentElement.parentElement.style.backgroundColor;
        inputTitle.value= filter.parentElement.parentElement.children[1].children[1].innerHTML;
        inputDesc.value= filter.parentElement.parentElement.children[1].children[2].innerHTML;
        inputTitle.setAttribute("disabled", "true");
        inputDesc.setAttribute("disabled", "true");
        eventTitle.innerHTML= filter.parentElement.parentElement.children[1].children[1].innerHTML;
        eventDate.innerHTML= filter.parentElement.parentElement.children[1].children[0].children[0].innerHTML;
    }
}
